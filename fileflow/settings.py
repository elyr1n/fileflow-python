...
# Наша PostgreSQL БД (подключаетесь к своей локальной БД, создать можно в pgAdmin 4).
DATABASES = {
    "default": {
...
# Кастомный бэкенд для аутентификации.
...
# По умолчанию RU язык, Московское время, при желании - меняем в .env.
...
# Сессии
SESSION_COOKIE_AGE = 5 * 60  # 5 минут
